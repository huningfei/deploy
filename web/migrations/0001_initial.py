# Generated by Django 2.1.4 on 2019-04-25 16:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, '发布中'), (2, '发布成功'), (3, '发布失败')], default=1, verbose_name='状态')),
                ('deploy_time', models.DateTimeField(auto_now_add=True, verbose_name='发布时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Branch_status', models.CharField(max_length=256, null=True, verbose_name='分支合并状态')),
                ('Influence', models.CharField(max_length=256, null=True, verbose_name='代码修改影响点')),
            ],
            options={
                'verbose_name': '上线单详情表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Online_time', models.DateTimeField(blank=True, max_length=256, verbose_name='上线日期')),
                ('Rollback_name', models.CharField(max_length=128, null=True, verbose_name='回滚方案')),
                ('Op_qz', models.CharField(max_length=256, null=True, verbose_name='运维签字')),
                ('Rd_qz', models.CharField(max_length=256, null=True, verbose_name='rd签字')),
                ('Test_qz', models.CharField(max_length=256, null=True, verbose_name='测试签字')),
                ('Ui_qz', models.CharField(max_length=256, null=True, verbose_name='ui签字')),
                ('Pm_qz', models.CharField(max_length=256, null=True, verbose_name='产品签字')),
                ('Zj_qz', models.CharField(max_length=256, null=True, verbose_name='总监签字')),
                ('Rallback_result', models.CharField(max_length=256, null=True, verbose_name='回归结果测试产品签字')),
                ('status', models.IntegerField(choices=[(1, '提交更新'), (2, '负责人审核'), (3, '预上线'), (4, '代码上线'), (5, '回归中'), (6, '回归完成'), (7, '回滚'), (8, '否决上线'), (9, '流程结束')], default=1, verbose_name='状态')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Rollback_name', models.CharField(max_length=128, verbose_name='回滚方案')),
                ('Development_qz', models.CharField(max_length=128, verbose_name='开发签字')),
                ('Project_qz', models.CharField(max_length=128, verbose_name='项目负责人签字')),
                ('Technical_qz', models.CharField(max_length=128, verbose_name='技术总监签字')),
                ('op_qz', models.CharField(max_length=256, verbose_name='运维签字')),
                ('Project_confirm_qz', models.CharField(max_length=128, verbose_name='项目负责人确认签字')),
            ],
        ),
        migrations.AddField(
            model_name='onlinedetails',
            name='details',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='web.Onlinelist'),
        ),
        migrations.AddField(
            model_name='onlinedetails',
            name='staff',
