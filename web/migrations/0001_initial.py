    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('select_project', models.CharField(max_length=128, verbose_name='选择项目负责人审核')),
                ('select_test', models.CharField(max_length=128, verbose_name='指定测试审核')),
                ('select_op', models.CharField(max_length=128, verbose_name='指定运维审核')),
                ('Op_qz', models.CharField(max_length=256, verbose_name='运维签字')),
                ('Rd_qz', models.CharField(max_length=256, verbose_name='rd签字')),
                ('Test_qz', models.CharField(max_length=256, verbose_name='测试签字')),
                ('Ui_qz', models.CharField(max_length=256, verbose_name='ui签字')),
                ('Pm_qz', models.CharField(max_length=256, verbose_name='产品签字')),
                ('Zj_qz', models.CharField(max_length=256, verbose_name='总监签字')),
                ('Rallback_result', models.CharField(max_length=256, verbose_name='回归结果测试产品签字')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('details', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='web.Onlinelist')),
