...
INSERT INTO `rbac_role_permissions` VALUES (2,1,1),(3,1,3),(4,1,5),(84,1,6),(85,1,7),(83,1,8),(7,1,9),(8,1,10),(9,1,11),(10,1,13),(11,1,14),(12,1,15),(13,1,16),(14,1,17),(15,1,18),(16,1,19),(17,1,20),(18,1,21),(19,1,29),(20,1,31),(1,1,32),(5,1,39),(6,1,40),(21,2,2),(22,2,3),(23,2,23),(24,2,24),(25,2,26),(26,3,1),(27,3,3),(28,3,22),(29,3,26),(30,3,28),(31,4,1),(32,4,22),(33,4,30),(34,5,1),(35,5,2),(36,5,3),(38,5,22),(39,5,23),(40,5,24),(41,5,26),(42,5,27),(37,5,37),(43,6,1),(44,6,2),(45,6,3),(46,6,4),(47,6,5),(48,6,6),(49,6,7),(50,6,8),(51,6,9),(52,6,10),(53,6,11),(54,6,12),(55,6,13),(56,6,14),(57,6,15),(58,6,16),(59,6,17),(60,6,18),(61,6,19),(62,6,20),(63,6,21),(64,6,22),(65,6,23),(66,6,24),(67,6,25),(68,6,26),(69,6,27),(70,6,28),(71,6,29),(72,6,30),(73,6,31),(74,6,32),(75,6,33),(76,6,34),(77,6,35),(78,6,36),(79,6,37),(80,6,38),(81,6,39),(82,6,40),(86,6,41),(87,6,42),(88,6,43),(89,6,44);
...
INSERT INTO `web_deploy` VALUES (1,'master','php20190627165226','2019-06-27 16:52:26.319701',3,1,1);
...
INSERT INTO `web_deployrecord` VALUES (1,'master',2,'2019-06-27 17:01:06.500453','发布成功','',1,1);
...
INSERT INTO `web_host` VALUES (1,'192.168.10.227',22),(2,'192.168.6.220',22);
...
CREATE TABLE `web_onlinedetails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Online_step` longtext NOT NULL,
  `Branch_status` varchar(256) NOT NULL,
  `Influence` varchar(256) NOT NULL,
  `details_id` int(11) NOT NULL,
  `staff_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `details_id` (`details_id`),
  KEY `web_onlinedetails_staff_id_b07a8126_fk_web_userinfo_id` (`staff_id`),
  CONSTRAINT `web_onlinedetails_details_id_9ec7877f_fk_web_onlinelist_id` FOREIGN KEY (`details_id`) REFERENCES `web_onlinelist` (`id`),
  CONSTRAINT `web_onlinedetails_staff_id_b07a8126_fk_web_userinfo_id` FOREIGN KEY (`staff_id`) REFERENCES `web_userinfo` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `web_onlinelist`
--

DROP TABLE IF EXISTS `web_onlinelist`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `web_onlinelist` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Online_project` varchar(256) NOT NULL,
  ...
  `Rd_qz` varchar(256) NOT NULL,
  `Test_qz` varchar(256) NOT NULL,
  `Ui_qz` varchar(256) NOT NULL,
  `Pm_qz` varchar(256) NOT NULL,
  `Zj_qz` varchar(256) NOT NULL,
  `Rallback_result` varchar(256) NOT NULL,
  `status` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `web_onlinelist`
--

LOCK TABLES `web_onlinelist` WRITE;
/*!40000 ALTER TABLE `web_onlinelist` DISABLE KEYS */;
/*!40000 ALTER TABLE `web_onlinelist` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `web_project` VALUES (1,'PHP','http://192.168.7.18/root/php.git',1,'/home/yx/server/nginx/html/',2);
...
INSERT INTO `web_project_hosts` VALUES (1,1,1),(2,1,2);
...
INSERT INTO `web_userinfo` VALUES (1,'pbkdf2_sha256$150000$BCsEccw4y0V1$PVPP/Agvts8WZ/AiWCCFji1g3J4HCxXe932gQA8+dIQ=','2019-06-27 16:50:06.207687',1,'admin','','','',1,1,'2019-06-27 14:41:18.428683','','',NULL,NULL,NULL,NULL);
...
-- Dump completed on 2019-06-27 17:11:52
